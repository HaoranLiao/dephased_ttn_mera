...
Efficient unitary tree tensor netwokr (TTN) and Multi-scale Entanglement Renormalization Ansatz (MERA) built in Tensorflow, with tunable local dephasing channels at every layer of the tensor networks, benchmarked on compressed MNIST, KMNIST, and Fashion-MNIST.
